...
company_name = "PFD Foods" #Company name for which rag data and model is being generated
accepted_domains = "www.pfdfoods.com.au" # Comma separated list of accepted domains to scrape, all other will be ignored, e.g. www.databricks.com for Databricks
catalog = "pfd_foods" # Catalog name where rag data and model will live
schema_name = "chatbot" # Schema name in catalog where rag data and model will live
sitemap_urls = "https://www.pfdfoods.com.au/sitemap.xml" # Comma separated list
...
logo_url = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5J5E8GbeGO1GBP4cAv3BoZJkU-q9DC0_9WQ&s"
example_q1 = f"What is {company_name}?"
example_q2 = "List questions can I ask?"
example_q3 = f"What is {company_name}' position on sustainability?"
example_q4 = f"What is {company_name}' policy on returning frozen goods?"
