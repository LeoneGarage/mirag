        ...
        h = [
            ...
            for tt in [
                ...
                if not h[1].startswith(
                    "I cannot answer questions that are not about Company A"
                )
            ]
            for t in tt
        ]
...
ci = gr.ChatInterface(
    ...
    description="This chatbot is a demo example of LLM chatbot built on Dataricks platform. <br>This content is provided as a LLM RAG educational example, without support. It is using LLama, has not been tested and should not be used as production content",
