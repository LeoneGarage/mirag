...
company_name = "Woolworths" #Company name for which rag data and model is being generated
accepted_domains = "www.woolworths.com.au" # Comma separated list of accepted domains to scrape, all other will be ignored, e.g. www.databricks.com for Databricks
catalog = "woolworths" # Catalog name where rag data and model will live
schema_name = "chatbot" # Schema name in catalog where rag data and model will live
sitemap_urls = "https://www.woolworths.com.au/sitemap_index.xml" # Comma separated list
