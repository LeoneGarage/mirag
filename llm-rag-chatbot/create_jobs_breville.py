...
company_name = "Breville" #Company name for which rag data and model is being generated
accepted_domains = "www.breville.com" # Comma separated list of accepted domains to scrape, all other will be ignored, e.g. www.databricks.com for Databricks
catalog = "breville" # Catalog name where rag data and model will live
schema_name = "chatbot" # Schema name in catalog where rag data and model will live
sitemap_urls = "https://www.breville.com/sitemap.xml" # Comma separated list
...
email = "leon.eller@databricks.com"#spark.sql('select current_user() as user').collect()[0]['user']
