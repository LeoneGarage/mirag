...
company_name = "SafetyCulture" #Company name for which rag data and model is being generated
accepted_domains = "safetyculture.com,blog.safetyculture.com" # Comma separated list of accepted domains to scrape, all other will be ignored, e.g. www.databricks.com for Databricks
catalog = "safetyculture" # Catalog name where rag data and model will live
schema_name = "chatbot" # Schema name in catalog where rag data and model will live
sitemap_urls = "https://safetyculture.com/sitemap.xml" # Comma separated list
...
logo_url = "https://embed-ssl.wistia.com/deliveries/37ba1cff6995353f53a8879424f963f3.jpg?image_crop_resized=640x360"
example_q1 = f"What is {company_name}?"
example_q2 = "List questions can I ask?"
example_q3 = f"How can {company_name} help improve operations in my business?"
example_q4 = f"What other products does {company_name} offer besides the preventive maintenance software?"
