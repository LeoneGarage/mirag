...
company_name = "Deputy" #Company name for which rag data and model is being generated
accepted_domains = "www.deputy.com, help.deputy.com" # Comma separated list of accepted domains to scrape, all other will be ignored, e.g. www.databricks.com for Databricks
catalog = "deputy" # Catalog name where rag data and model will live
schema_name = "chatbot" # Schema name in catalog where rag data and model will live
sitemap_urls = "https://www.deputy.com/sitemap_index.xml,https://help.deputy.com/hc/sitemap.xml" # Comma separated list
