...
company_name = "Dovetail" #Company name for which rag data and model is being generated
accepted_domains = "dovetail.com" # Comma separated list of accepted domains to scrape, all other will be ignored, e.g. www.databricks.com for Databricks
catalog = "dovetail" # Catalog name where rag data and model will live
schema_name = "chatbot" # Schema name in catalog where rag data and model will live
sitemap_urls = "https://dovetail.com/sitemap-index.xml" # Comma separated list
